...
const ZH_CN: Record<string, string> = {
  ...
  "jobs.queueMix": "图片 {imageCount} / 视频 {videoCount}",
  ...
  "jobs.kindVideo": "视频",
  "jobs.kindImage": "图片",
  "jobs.previewImage": "查看大图",
  "jobs.previewVideo": "播放视频",
  "jobs.lightboxIndex": "第 {index} / {total} 张",
  "jobs.lightboxPrev": "上一张",
  "jobs.lightboxNext": "下一张",
  "jobs.lightboxOpenOriginal": "打开原图",
  "jobs.lightboxDownload": "下载图片",
  "jobs.lightboxOpenOriginalVideo": "打开原视频",
  "jobs.lightboxDownloadVideo": "下载视频",
  "jobs.advancedFilters": "高级筛选",
  "jobs.assetEmpty": "暂无匹配作品。",
  "jobs.assetDetailTitle": "作品详情",
  "jobs.primaryRefine": "复用并改一版",
  "jobs.primaryRefineHint": "修改上方提示词后，可使用“复用并改一版”。",
  "jobs.moreActions": "更多操作",
  "jobs.reusePrompt": "复用 Prompt",
  ...
  "jobs.resolution": "分辨率",
  "jobs.created": "创建时间",
  "jobs.openOriginal": "打开原文件",
  "jobs.download": "下载文件",
  "jobs.deleteFailed": "删除失败：{message}",
  "jobs.retry": "重试 ({mode})",
  "jobs.fullscreenPlay": "全屏播放",
  "jobs.rawResult": "原始结果",
  "jobs.originalImageLinks": "原始图片链接",
  "jobs.selectHint": "请选择作品查看详情。",
  "jobs.generationFailed": "生成失败",
  ...
  "jobs.imageStatusQueued": "图片排队中",
  "jobs.imageStatusQueuedWithPosition": "图片排队中 (前方 {position})",
  "jobs.imageStatusRunning": "图片生成中",
  "jobs.imageStatusSucceeded": "已完成",
  "jobs.videoStatusQueued": "视频排队中",
  "jobs.videoStatusQueuedWithPosition": "视频排队中 (前方 {position})",
  "jobs.videoStatusRunning": "视频生成中",
  "jobs.videoStatusSucceeded": "已完成",
  "jobs.immersiveMode": "沉浸模式",
  "jobs.showDetails": "显示详情",
  "status.queued": "排队中",
  "status.running": "执行中",
  "status.succeeded": "成功",
  "status.failed": "失败",
  ...
  "jobs.favorite": "收藏",
  "jobs.unfavorite": "取消收藏",
  "jobs.workPreview": "作品预览",
  "jobs.showInfo": "显示信息",
  "jobs.hideInfo": "隐藏信息",
  "jobs.back": "返回浏览",
  "jobs.portraitHint": "纵向作品：保持原始纵向比例展示。",
  "jobs.landscapeHint": "横向作品：优先铺宽展示。",
  "jobs.videoLoading": "视频加载中…",
  "jobs.pageSubtitle": "浏览作品，点击卡片查看详情。",
  "jobs.statsAll": "全部 {count}",
  "jobs.statsImages": "图片 {count}",
...
const EN: Record<string, string> = {
  ...
  "jobs.queueMix": "Images {imageCount} / Videos {videoCount}",
  ...
  "jobs.previewImage": "Preview",
  "jobs.previewVideo": "Play Video",
  "jobs.lightboxIndex": "{index} / {total}",
  "jobs.lightboxPrev": "Previous",
  "jobs.lightboxNext": "Next",
  "jobs.lightboxOpenOriginal": "Open Original",
  "jobs.lightboxDownload": "Download",
  "jobs.lightboxOpenOriginalVideo": "Open Original Video",
  "jobs.lightboxDownloadVideo": "Download Video",
  "jobs.advancedFilters": "Advanced Filters",
  "jobs.assetEmpty": "No matching works found.",
  "jobs.assetDetailTitle": "Work Detail",
  ...
  "jobs.openOriginal": "Open Original",
  ...
  "jobs.originalImageLinks": "Original Image Links",
  "jobs.selectHint": "Select a work to view details.",
  "jobs.generationFailed": "Generation Failed",
  ...
  "jobs.imageStatusQueued": "Image queued",
  "jobs.imageStatusQueuedWithPosition": "Image queued ({position} ahead)",
  "jobs.imageStatusRunning": "Image generating",
  "jobs.imageStatusSucceeded": "Image done",
  "jobs.videoStatusQueued": "Video queued",
  "jobs.videoStatusQueuedWithPosition": "Video queued ({position} ahead)",
  "jobs.videoStatusRunning": "Video generating",
  "jobs.videoStatusSucceeded": "Video done",
  "jobs.immersiveMode": "Immersive Mode",
  "jobs.showDetails": "Show Details",
  ...
  "jobs.workPreview": "Work Preview",
  "jobs.showInfo": "Show Info",
  "jobs.hideInfo": "Hide Info",
  "jobs.back": "Back",
  "jobs.portraitHint": "Portrait asset: keeps vertical composition.",
  "jobs.landscapeHint": "Landscape asset: rendered with wide priority.",
  "jobs.videoLoading": "Loading video...",
  "jobs.pageSubtitle": "Browse your creations. Click a card to view details.",
  "jobs.statsAll": "All {count}",
  "jobs.statsImages": "Images {count}",
